...
class Grid3x3():
    ...
    def __init__(self, calc_slabs=None, slbInteractx=None, slbInteracty=None, 
                 xparam='', yparam='',
        ...
        self.get_residual = get_residual
